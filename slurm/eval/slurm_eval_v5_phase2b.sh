...
#SBATCH --gres=gpu:1
#SBATCH --time=4:00:00
#SBATCH --output=logs/eval_v5_phase2b_%j.log
...
mkdir -p $PIPE/logs $PIPE/eval_output/v5_phase2b

echo "=== Delphi v5 Phase 2b AUC Evaluation ==="
echo "Node: $(hostname)  GPU: $CUDA_VISIBLE_DEVICES"
echo ""

cd $DELPHI

echo "=== v5 phase2b + GM (select=right) ==="
echo "Start: $(date)"
...
echo "=== AUC Summary (filter_min_total >= 50) ==="
